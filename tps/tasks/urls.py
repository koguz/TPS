...
urlpatterns = [
    ...
    path('tasks/<int:team_id>/<int:task_id>/', views.view_task, name='view_task'),
    path('tasks/<int:team_id>/<int:task_id>/edit/', views.edit_task, name='edit_task'),
    path('tasks/<int:team_id>/<int:task_id>/complete/', views.complete_task, name='complete_task'),
    path('tasks/<int:team_id>/<int:task_id>/liked/<int:liked>/', views.like_task, name='like_task'),
